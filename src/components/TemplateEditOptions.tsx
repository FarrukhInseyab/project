...
interface TemplateEditOptionsProps {
  isOpen: boolean;
  onClose: () => void;
...
export const TemplateEditOptions: React.FC<TemplateEditOptionsProps> = ({
  isOpen,
  onClose,
  onUploadNewVersion,
  onEditInOnlyOffice,
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
        ...
        <div className="p-6">
          <p className="text-gray-700 mb-6">
            How would you like to edit <span className="font-semibold">{templateName}</span>?
          </p>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <div className="font-semibold text-gray-900">Upload New Version</div>
                  <div className="text-sm text-gray-600">Replace with a new DOCX file</div>
                </div>
              </div>
            </button>

            <button
              onClick={onEditInOnlyOffice}
