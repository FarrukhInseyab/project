...
export const TemplateViewOptions: React.FC<TemplateViewOptionsProps> = ({
  isOpen,
  onClose,
  onDownload,
  onOpenInEditor,
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
        ...
        <div className="border-b border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">View Template</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          <p className="text-gray-700 mb-6">
            How would you like to view <span className="font-semibold">{templateName}</span>?
          </p>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <div className="font-semibold text-blue-900">Open in My Editor</div>
                  <div className="text-sm text-blue-600">View in the document editor</div>
                </div>
              </div>
            </button>
          </div>
