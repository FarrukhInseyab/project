...
-- This migration uses the auth.config table approach which doesn't require superuser privileges

-- Create the auth.config table if it doesn't exist
CREATE TABLE IF NOT EXISTS auth.config (
  key TEXT PRIMARY KEY,
  value TEXT NOT NULL
);

-- Insert or update SMTP configuration
