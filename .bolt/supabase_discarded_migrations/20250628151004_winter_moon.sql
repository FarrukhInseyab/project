/*
  ...
  including all tables, functions, triggers, indexes, and security policies.
  ...
  2. Security
    ...
    - Proper permission controls for shared resources
    - Secure storage access policies

  3. Performance
    - Optimized indexes for common queries
    - Full-text search capabilities
    - Efficient storage of document content
*/
...
-- ProofofDebitAPI table (for integration with external systems)
...
-- Create trigger for template search vector updates
...
-- Create trigger for new templates to create initial version
